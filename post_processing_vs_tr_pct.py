...
tr_pct_range = np.arange(0.0, 0.825, 0.025)
...
plt.savefig(figure_foldername + '/vs_tr_pct' + '-val_' + evaluation_names[validation_evaluation_idx] + '-plot_' + evaluation_names[plot_evaluation_idx] + '-merge_test_' + str(merge_test) + '.png', pad_inches=0)
time.sleep(0.1)
